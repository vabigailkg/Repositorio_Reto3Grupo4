...
class PeliculaTest {
	...
	public void testGetNombre() {
		String nombrePeli = peli.getNombre();
	...
	public void testGetDuracion() {
		int duracionPeli = peli.getDuracion();
	...
	public void testGetGenero() {
		String generoPeli = peli.getGenero();
	...
	public void testSetId() {
		...
		peli.setId(123);
		assertEquals(123, peli.getId());
		assertNotEquals("Id no correcto", 124, peli.getId());
		assertEquals("Error en el Id", 14, peli.getId());
	...
	public void testSetDuracion() {
		...
		peli.setDuracion(150);
		assertEquals(150, peli.getDuracion());
		assertNotEquals("Duracion no correcto", 124, peli.getDuracion());
		assertEquals("Error en la Duracion", 14, peli.getDuracion());
	...
	public void testSetGenero() {
		...
		assertEquals("Terror", peli.getGenero());
		assertNotEquals("Genero no correcto", "Drama", peli.getGenero());
		assertEquals("Error en el Genero", "Comedia", peli.getGenero());
	...
	public void testSetCoste() {
		...
		peli.setCoste(1500);
		assertEquals(1500, peli.getCoste());
		assertNotEquals("Coste no correcto", 124, peli.getCoste());
		assertEquals("Error en el Coste", 14, peli.getCoste());
	...
	public void testSetNombre() {
		...
		peli.setNombre("ElConjuro");
		assertEquals("ElConjuro", peli.getNombre());
		assertNotEquals("Nombre no correcto", "ElConjuro", peli.getNombre());
		assertEquals("Error en el nombre", "ElConjuro", peli.getNombre());
